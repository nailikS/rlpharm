...
# config = {"policy_type": "MultiInputPolicy", "total_timesteps": 100000}
...
query = r'C:\\Users\\kilia\\MASTER\\rlpharm\data\\querys\\sEH-3ANT[A]-modifiziert-LS-3.02.pml'
register(
    # unique identifier for the env `name-version`
    ...
    kwargs={
        ...
        "enable_approximator": False,
        "hybrid_reward": True,
        "buffer_path": r"C:\Users\kilia\MASTER\rlpharm\data\sEH-3ANT[A]-modifiziert-LS-3.02.csv",
        "inf_mode": False,
        "threshold": 0.78,
        "render_mode": "console",
        "verbose": 3,
